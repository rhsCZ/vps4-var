...
$config['des_key'] = 'uu5f4tM87ZNN2IdISODWDzIW';

// ----------------------------------
// PLUGINS
// ----------------------------------
// List of active plugins (in plugins/ directory)
$config['plugins'] = ['acl', 'archive', 'attachment_reminder', 'emoticons', 'filesystem_attachments', 'help', 'jqueryui', 'userinfo', 'zipdownload'];
